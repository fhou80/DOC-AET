...
if __name__ == "__main__":
    ...
    _, aet_entity_embeddings = utils.load_voca_embs(voca_emb_dir + 'dict.entity',
                                                          voca_emb_dir + 'aligned_atee_entity_vec_100d.npy')
    aet_word_voca, aet_word_embeddings = utils.load_voca_embs(voca_emb_dir + 'atee_type_dict_100d.txt',
    ...
    config = {'hid_dims': args.hid_dims,
              ...
              'aet_entity_embeddings': aet_entity_embeddings,
              'snd_word_voca': snd_word_voca,
              'snd_word_embeddings': snd_word_embeddings,
              'aet_dims': aet_entity_embeddings.shape[1],
